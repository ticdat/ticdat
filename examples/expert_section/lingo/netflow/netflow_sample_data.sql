...
INSERT INTO [nodes] ([name]) VALUES ('New_York');
...
INSERT INTO [cost] ([commodity],[source],[destination],[cost]) VALUES ('Pencils','Detroit','New_York',20.0);
INSERT INTO [cost] ([commodity],[source],[destination],[cost]) VALUES ('Pens','Detroit','New_York',20.0);
...
INSERT INTO [cost] ([commodity],[source],[destination],[cost]) VALUES ('Pens','Denver','New_York',70.0);
INSERT INTO [cost] ([commodity],[source],[destination],[cost]) VALUES ('Pens','Denver','Boston',60.0);
INSERT INTO [cost] ([commodity],[source],[destination],[cost]) VALUES ('Pencils','Denver','New_York',40.0);
...
INSERT INTO [arcs] ([source],[destination],[capacity]) VALUES ('Detroit','New_York',80.0);
INSERT INTO [arcs] ([source],[destination],[capacity]) VALUES ('Denver','New_York',120.0);
...
INSERT INTO [inflow] ([commodity],[node],[quantity]) VALUES ('Pens','New_York',-30.0);
...
INSERT INTO [inflow] ([commodity],[node],[quantity]) VALUES ('Pencils','New_York',-50.0);
