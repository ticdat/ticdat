# Extend initial_example/diet.py to have command line functionality.
# For example, typing
#   python diet.py -i diet.xls -o solution.xls
# will read from a model stored in the diet.xls file and write the solution to a file called solution.xls
# The command line functionality will infer the file type from the file extension.
# This functionality is implemented in the if __name__ == "__main__": below.
