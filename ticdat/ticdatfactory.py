...
"""when making a simple foreign key, mappings should be a list of the form [native field, foreign field]""")
    ...
    def clone_change_columns(self, table, pk_fields, df_fields):
        ...
        :return: a clone of the TicDatFactory, with the table adjusted to have only the fields referred to
        ...
        def clone_factory(full_schema):
            ...
            return TicDatFactory.create_from_full_schema(full_schema)
